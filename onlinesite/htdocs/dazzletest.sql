...
CREATE TABLE IF NOT EXISTS `dzg_AccessMap` (
...
--
-- 转存表中的数据 `dzg_AccessMap`
--

INSERT INTO `dzg_AccessMap` (`dz_accessListId`, `dz_userOrGroupId`, `dz_permission`) VALUES
(8, 6, 2147483647),
(9, 6, 2147483647),
(9, 4, 7),
(10, 4, 7),
...
--
-- 表的结构 `dzg_AccessSubscriberMap`
--

CREATE TABLE IF NOT EXISTS `dzg_AccessSubscriberMap` (
...
--
-- 转存表中的数据 `dzg_AccessSubscriberMap`
--

INSERT INTO `dzg_AccessSubscriberMap` (`dz_itemId`, `dz_accessListId`) VALUES
(7, 10),
(11, 10),
(12, 10),
(13, 10),
...
CREATE TABLE IF NOT EXISTS `dzg_AlbumItem` (
...
--
-- 转存表中的数据 `dzg_AlbumItem`
--

INSERT INTO `dzg_AlbumItem` (`dz_id`, `dz_theme`, `dz_orderBy`, `dz_orderDirection`) VALUES
(7, '', '', 'asc'),
(11, '', '', 'asc'),
(12, '', '', 'asc'),
(13, '', '', 'asc'),
...
--
-- 表的结构 `dzg_AnimationItem`
--

CREATE TABLE IF NOT EXISTS `dzg_AnimationItem` (
  `dz_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `dzg_CacheMap` (
...
--
-- 表的结构 `dzg_ChildEntity`
--

CREATE TABLE IF NOT EXISTS `dzg_ChildEntity` (
  `dz_id` int(11) NOT NULL,
...
--
-- 转存表中的数据 `dzg_ChildEntity`
--

INSERT INTO `dzg_ChildEntity` (`dz_id`, `dz_parentId`) VALUES
(7, 0),
(11, 7),
(12, 7),
(13, 7),
...
--
-- 表的结构 `dzg_CustomFieldMap`
--

CREATE TABLE IF NOT EXISTS `dzg_CustomFieldMap` (
  `dz_itemId` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `dzg_DataItem` (
  `dz_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `dzg_Derivative` (
  `dz_id` int(11) NOT NULL,
...
--
-- 表的结构 `dzg_DerivativeImage`
--

CREATE TABLE IF NOT EXISTS `dzg_DerivativeImage` (
  `dz_id` int(11) NOT NULL,
  `dz_width` int(11) DEFAULT NULL,
  `dz_height` int(11) DEFAULT NULL,
  PRIMARY KEY (`dz_id`)
...
--
-- 表的结构 `dzg_DerivativePrefsMap`
--

CREATE TABLE IF NOT EXISTS `dzg_DerivativePrefsMap` (
...
--
-- 转存表中的数据 `dzg_DerivativePrefsMap`
--

INSERT INTO `dzg_DerivativePrefsMap` (`dz_itemId`, `dz_order`, `dz_derivativeType`, `dz_derivativeOperations`) VALUES
(7, 0, 1, 'thumbnail|150'),
(11, 0, 1, 'thumbnail|150'),
(12, 0, 1, 'thumbnail|150'),
(13, 0, 1, 'thumbnail|150'),
(11, 0, 2, 'scale|560,935'),
(14, 0, 1, 'thumbnail|150'),
(14, 0, 2, 'scale|560,935'),
(15, 0, 2, 'scale|560,935'),
(15, 0, 1, 'thumbnail|150'),
(7, 0, 2, 'scale|560,935'),
(12, 0, 2, 'scale|560,935'),
(13, 0, 2, 'scale|560,935'),
(16, 0, 1, 'thumbnail|150'),
(16, 0, 2, 'scale|560,935'),
(17, 0, 1, 'thumbnail|150'),
(17, 0, 2, 'scale|560,935'),
(18, 0, 1, 'thumbnail|150'),
(18, 0, 2, 'scale|560,935'),
(19, 0, 1, 'thumbnail|150'),
(19, 0, 2, 'scale|560,935');

-- --------------------------------------------------------

--
-- 表的结构 `dzg_DescendentCountsMap`
--

CREATE TABLE IF NOT EXISTS `dzg_DescendentCountsMap` (
  `dz_userId` int(11) NOT NULL,
  `dz_itemId` int(11) NOT NULL,
...
--
-- 转存表中的数据 `dzg_DescendentCountsMap`
--

INSERT INTO `dzg_DescendentCountsMap` (`dz_userId`, `dz_itemId`, `dz_descendentCount`) VALUES
(5, 12, 2),
(6, 16, 0),
(6, 18, 0),
(6, 15, 0),
...
CREATE TABLE IF NOT EXISTS `dzg_Entity` (
  `dz_id` int(11) NOT NULL,
...
INSERT INTO `dzg_Entity` (`dz_id`, `dz_creationTimestamp`, `dz_isLinkable`, `dz_linkId`, `dz_modificationTimestamp`, `dz_serialNumber`, `dz_entityType`, `dz_onLoadHandlers`) VALUES
(1, 1402940308, 0, NULL, 1402940308, 1, 'GalleryEntity', NULL),
(2, 1402940308, 0, NULL, 1402940308, 1, 'GalleryGroup', NULL),
(3, 1402940308, 0, NULL, 1402940308, 1, 'GalleryGroup', NULL),
(4, 1402940308, 0, NULL, 1402940308, 1, 'GalleryGroup', NULL),
(5, 1402940308, 0, NULL, 1402940308, 1, 'GalleryUser', NULL),
(6, 1402940308, 0, NULL, 1402940308, 1, 'GalleryUser', NULL),
(7, 1402940308, 0, NULL, 1402940987, 4, 'GalleryAlbumItem', NULL),
(11, 1402940938, 0, NULL, 1402941286, 3, 'GalleryAlbumItem', NULL),
(12, 1402940967, 0, NULL, 1402941386, 3, 'GalleryAlbumItem', NULL),
(13, 1402940987, 0, NULL, 1402941410, 3, 'GalleryAlbumItem', NULL),
(14, 1402941249, 0, NULL, 1402947376, 5, 'GalleryAlbumItem', NULL),
(15, 1402941286, 0, NULL, 1402941286, 1, 'GalleryAlbumItem', NULL),
(16, 1402941378, 0, NULL, 1402941378, 1, 'GalleryAlbumItem', NULL),
(17, 1402941386, 0, NULL, 1402941386, 1, 'GalleryAlbumItem', NULL),
(18, 1402941402, 0, NULL, 1402941402, 1, 'GalleryAlbumItem', NULL),
(19, 1402941410, 0, NULL, 1402941410, 1, 'GalleryAlbumItem', NULL);

-- --------------------------------------------------------

--
-- 表的结构 `dzg_EventLogMap`
--

CREATE TABLE IF NOT EXISTS `dzg_EventLogMap` (
  `dz_id` int(11) NOT NULL,
...
--
-- 表的结构 `dzg_ExternalIdMap`
--

CREATE TABLE IF NOT EXISTS `dzg_ExternalIdMap` (
...
CREATE TABLE IF NOT EXISTS `dzg_FactoryMap` (
...
--
-- 转存表中的数据 `dzg_FactoryMap`
--

INSERT INTO `dzg_FactoryMap` (`dz_classType`, `dz_className`, `dz_implId`, `dz_implPath`, `dz_implModuleId`, `dz_hints`, `dz_orderWeight`) VALUES
...
--
-- 表的结构 `dzg_FailedLoginsMap`
--

CREATE TABLE IF NOT EXISTS `dzg_FailedLoginsMap` (
...
--
-- 表的结构 `dzg_FileSystemEntity`
--

CREATE TABLE IF NOT EXISTS `dzg_FileSystemEntity` (
  `dz_id` int(11) NOT NULL,
...
--
-- 转存表中的数据 `dzg_FileSystemEntity`
--

INSERT INTO `dzg_FileSystemEntity` (`dz_id`, `dz_pathComponent`) VALUES
(7, NULL),
(11, 'dazzle'),
(12, 'dzzit'),
(13, 'diamond'),
...
CREATE TABLE IF NOT EXISTS `dzg_Group` (
  `dz_id` int(11) NOT NULL,
...
INSERT INTO `dzg_Group` (`dz_id`, `dz_groupType`, `dz_groupName`) VALUES
...
CREATE TABLE IF NOT EXISTS `dzg_Item` (
  `dz_id` int(11) NOT NULL,
...
INSERT INTO `dzg_Item` (`dz_id`, `dz_canContainChildren`, `dz_description`, `dz_keywords`, `dz_ownerId`, `dz_renderer`, `dz_summary`, `dz_title`, `dz_viewedSinceTimestamp`, `dz_originationTimestamp`) VALUES
(7, 1, 'This is the main page of your Gallery', NULL, 6, NULL, NULL, 'Gallery', 1402940308, 1402940308),
(11, 1, '', '', 6, NULL, '', '', 1402940938, 1402940938),
(12, 1, '', '', 6, NULL, '', '', 1402940967, 1402940967),
(13, 1, '', '', 6, NULL, '', '', 1402940987, 1402940987),
(14, 1, '', '', 6, NULL, '', '', 1402941249, 1402941249),
(15, 1, '', '', 6, NULL, '', '', 1402941286, 1402941286),
(16, 1, '', '', 6, NULL, '', '', 1402941378, 1402941378),
(17, 1, '', '', 6, NULL, '', '', 1402941386, 1402941386),
(18, 1, '', '', 6, NULL, '', '', 1402941402, 1402941402),
(19, 1, '', '', 6, NULL, '', '', 1402941410, 1402941410);

-- --------------------------------------------------------

--
-- 表的结构 `dzg_ItemAttributesMap`
--

CREATE TABLE IF NOT EXISTS `dzg_ItemAttributesMap` (
  `dz_itemId` int(11) NOT NULL,
...
--
-- 转存表中的数据 `dzg_ItemAttributesMap`
--

INSERT INTO `dzg_ItemAttributesMap` (`dz_itemId`, `dz_viewCount`, `dz_orderWeight`, `dz_parentSequence`) VALUES
(7, 3, 0, ''),
(11, 2, 1000, '7/'),
(12, 1, 2000, '7/'),
(13, 1, 3000, '7/'),
...
CREATE TABLE IF NOT EXISTS `dzg_Lock` (
...
--
-- 表的结构 `dzg_MaintenanceMap`
--

CREATE TABLE IF NOT EXISTS `dzg_MaintenanceMap` (
...
--
-- 表的结构 `dzg_MimeTypeMap`
--

CREATE TABLE IF NOT EXISTS `dzg_MimeTypeMap` (
...
--
-- 转存表中的数据 `dzg_MimeTypeMap`
--

INSERT INTO `dzg_MimeTypeMap` (`dz_extension`, `dz_mimeType`, `dz_viewable`) VALUES
...
CREATE TABLE IF NOT EXISTS `dzg_MovieItem` (
  `dz_id` int(11) NOT NULL,
  `dz_width` int(11) DEFAULT NULL,
  `dz_height` int(11) DEFAULT NULL,
...
--
-- 表的结构 `dzg_PermissionSetMap`
--

CREATE TABLE IF NOT EXISTS `dzg_PermissionSetMap` (
...
--
-- 转存表中的数据 `dzg_PermissionSetMap`
--

INSERT INTO `dzg_PermissionSetMap` (`dz_module`, `dz_permission`, `dz_description`, `dz_bits`, `dz_flags`) VALUES
...
CREATE TABLE IF NOT EXISTS `dzg_PhotoItem` (
  `dz_id` int(11) NOT NULL,
  `dz_width` int(11) DEFAULT NULL,
  `dz_height` int(11) DEFAULT NULL,
  PRIMARY KEY (`dz_id`)
...
CREATE TABLE IF NOT EXISTS `dzg_PluginMap` (
...
--
-- 转存表中的数据 `dzg_PluginMap`
--

INSERT INTO `dzg_PluginMap` (`dz_pluginType`, `dz_pluginId`, `dz_active`) VALUES
('theme', 'matrix', 1),
('module', 'core', 1),
...
--
-- 表的结构 `dzg_PluginPackageMap`
--

CREATE TABLE IF NOT EXISTS `dzg_PluginPackageMap` (
  `dz_pluginType` varchar(32) NOT NULL,
  `dz_pluginId` varchar(32) NOT NULL,
...
--
-- 转存表中的数据 `dzg_PluginPackageMap`
--

INSERT INTO `dzg_PluginPackageMap` (`dz_pluginType`, `dz_pluginId`, `dz_packageName`, `dz_packageVersion`, `dz_packageBuild`, `dz_locked`) VALUES
('theme', 'matrix', 'base', '1.1.6', '20955', 0),
('theme', 'matrix', 'lang-af', '15342', '18175', 0),
('theme', 'matrix', 'lang-ar', '15342', '20954', 0),
('theme', 'matrix', 'lang-ca', '15342', '18175', 0),
('theme', 'matrix', 'lang-cs', '15342', '18175', 0),
('theme', 'matrix', 'lang-da', '15342', '18175', 0),
('theme', 'matrix', 'lang-de', '15342', '18175', 0),
('theme', 'matrix', 'lang-el', '15342', '18175', 0),
('theme', 'matrix', 'lang-en_GB', '15342', '18175', 0),
('theme', 'matrix', 'lang-es', '15342', '18175', 0),
('theme', 'matrix', 'lang-es_AR', '15342', '18175', 0),
('theme', 'matrix', 'lang-es_MX', '15342', '20954', 0),
('theme', 'matrix', 'lang-eu', '15342', '18175', 0),
('theme', 'matrix', 'lang-fa', '15342', '18175', 0),
('theme', 'matrix', 'lang-fi', '15342', '18175', 0),
('theme', 'matrix', 'lang-fr', '15342', '20954', 0),
('theme', 'matrix', 'lang-ga', '15342', '20954', 0),
('theme', 'matrix', 'lang-he', '15342', '18175', 0),
('theme', 'matrix', 'lang-hu', '15342', '18175', 0),
('theme', 'matrix', 'lang-is', '15342', '20954', 0),
('theme', 'matrix', 'lang-it', '15342', '18175', 0),
('theme', 'matrix', 'lang-ja', '15342', '18175', 0),
('theme', 'matrix', 'lang-ko', '15342', '18175', 0),
('theme', 'matrix', 'lang-lt', '15342', '18175', 0),
('theme', 'matrix', 'lang-lv', '15342', '18175', 0),
('theme', 'matrix', 'lang-nl', '15342', '18175', 0),
('theme', 'matrix', 'lang-no', '15342', '18175', 0),
('theme', 'matrix', 'lang-pl', '15342', '18175', 0),
('theme', 'matrix', 'lang-pt', '15342', '20954', 0),
('theme', 'matrix', 'lang-pt_BR', '15342', '20954', 0),
('theme', 'matrix', 'lang-ro', '15342', '20954', 0),
('theme', 'matrix', 'lang-ru', '15342', '18175', 0),
('theme', 'matrix', 'lang-sk', '15342', '20954', 0),
('theme', 'matrix', 'lang-sr', '15342', '18175', 0),
('theme', 'matrix', 'lang-sv', '15342', '18175', 0),
('theme', 'matrix', 'lang-tr', '15342', '18175', 0),
('theme', 'matrix', 'lang-uk', '15342', '18175', 0),
('theme', 'matrix', 'lang-vi', '15342', '18175', 0),
('theme', 'matrix', 'lang-zh_CN', '15342', '18175', 0),
('theme', 'matrix', 'lang-zh_TW', '15342', '18175', 0),
('module', 'core', 'base', '1.3.0.2', '20997', 0),
('module', 'core', 'lang-af', '18153', '18173', 0),
('module', 'core', 'lang-ar', '18153', '18173', 0),
('module', 'core', 'lang-bg', '18153', '18173', 0),
('module', 'core', 'lang-ca', '18153', '18173', 0),
('module', 'core', 'lang-cs', '18153', '18173', 0),
('module', 'core', 'lang-da', '18153', '18173', 0),
('module', 'core', 'lang-de', '18153', '18173', 0),
('module', 'core', 'lang-el', '18153', '20954', 0),
('module', 'core', 'lang-en_GB', '18153', '18173', 0),
('module', 'core', 'lang-es', '18153', '18173', 0),
('module', 'core', 'lang-es_AR', '18153', '18173', 0),
('module', 'core', 'lang-es_MX', '18153', '18173', 0),
('module', 'core', 'lang-et', '18153', '18173', 0),
('module', 'core', 'lang-eu', '18153', '18173', 0),
('module', 'core', 'lang-fa', '18153', '18173', 0),
('module', 'core', 'lang-fi', '18153', '18173', 0),
('module', 'core', 'lang-fr', '18153', '20954', 0),
('module', 'core', 'lang-ga', '18153', '18173', 0),
('module', 'core', 'lang-he', '18153', '18173', 0),
('module', 'core', 'lang-hu', '18153', '18173', 0),
('module', 'core', 'lang-is', '18153', '18173', 0),
('module', 'core', 'lang-it', '18153', '18173', 0),
('module', 'core', 'lang-ja', '18153', '18173', 0),
('module', 'core', 'lang-ko', '18153', '18173', 0),
('module', 'core', 'lang-lt', '18153', '18173', 0),
('module', 'core', 'lang-lv', '18153', '18173', 0),
('module', 'core', 'lang-nl', '18153', '18173', 0),
('module', 'core', 'lang-no', '18153', '18173', 0),
('module', 'core', 'lang-pl', '18153', '18173', 0),
('module', 'core', 'lang-pt', '18153', '18173', 0),
('module', 'core', 'lang-pt_BR', '18153', '18173', 0),
('module', 'core', 'lang-ro', '18153', '18173', 0),
('module', 'core', 'lang-ru', '18153', '18173', 0),
('module', 'core', 'lang-sk', '18153', '20954', 0),
('module', 'core', 'lang-sl', '18153', '20954', 0),
('module', 'core', 'lang-sr', '18153', '18173', 0),
('module', 'core', 'lang-sv', '18153', '18173', 0),
('module', 'core', 'lang-tr', '18153', '18173', 0),
('module', 'core', 'lang-uk', '18153', '18173', 0),
('module', 'core', 'lang-vi', '18153', '18173', 0),
('module', 'core', 'lang-zh_CN', '18153', '18173', 0),
('module', 'core', 'lang-zh_TW', '18153', '20954', 0),
('module', 'customfield', 'base', '1.0.13', '20955', 0),
('module', 'customfield', 'lang-af', '15447', '18173', 0),
('module', 'customfield', 'lang-ar', '15447', '20954', 0),
('module', 'customfield', 'lang-ca', '15447', '18173', 0),
('module', 'customfield', 'lang-cs', '15447', '20954', 0),
('module', 'customfield', 'lang-da', '15447', '18173', 0),
('module', 'customfield', 'lang-de', '15447', '18173', 0),
('module', 'customfield', 'lang-el', '15447', '20954', 0),
('module', 'customfield', 'lang-en_GB', '15447', '18173', 0),
('module', 'customfield', 'lang-es', '15447', '18173', 0),
('module', 'customfield', 'lang-eu', '15447', '18173', 0),
('module', 'customfield', 'lang-fi', '15447', '18173', 0),
('module', 'customfield', 'lang-fr', '15447', '20954', 0),
('module', 'customfield', 'lang-hu', '15447', '18173', 0),
('module', 'customfield', 'lang-is', '15447', '20954', 0),
('module', 'customfield', 'lang-it', '15447', '18173', 0),
('module', 'customfield', 'lang-ja', '15447', '18173', 0),
('module', 'customfield', 'lang-ko', '15447', '18173', 0),
('module', 'customfield', 'lang-lt', '15447', '18173', 0),
('module', 'customfield', 'lang-nl', '15447', '18173', 0),
('module', 'customfield', 'lang-no', '15447', '18173', 0),
('module', 'customfield', 'lang-pl', '15447', '18173', 0),
('module', 'customfield', 'lang-ro', '15447', '18173', 0),
('module', 'customfield', 'lang-ru', '15447', '18173', 0),
('module', 'customfield', 'lang-sk', '15447', '18173', 0),
('module', 'customfield', 'lang-sr', '15447', '18173', 0),
('module', 'customfield', 'lang-sv', '15447', '18173', 0),
('module', 'customfield', 'lang-tr', '15447', '18173', 0),
('module', 'customfield', 'lang-uk', '15447', '18173', 0),
('module', 'customfield', 'lang-vi', '15447', '18173', 0),
('module', 'customfield', 'lang-zh_CN', '15447', '18173', 0),
('module', 'customfield', 'lang-zh_TW', '15447', '18173', 0),
('module', 'httpauth', 'base', '1.0.4', '20961', 0),
('module', 'httpauth', 'lang-af', '15727', '18173', 0),
('module', 'httpauth', 'lang-ar', '15727', '20954', 0),
('module', 'httpauth', 'lang-ca', '15727', '18173', 0),
('module', 'httpauth', 'lang-cs', '15727', '18173', 0),
('module', 'httpauth', 'lang-da', '15727', '18173', 0),
('module', 'httpauth', 'lang-de', '15727', '18173', 0),
('module', 'httpauth', 'lang-el', '15727', '20954', 0),
('module', 'httpauth', 'lang-en_GB', '15727', '18173', 0),
('module', 'httpauth', 'lang-es', '15727', '18173', 0),
('module', 'httpauth', 'lang-eu', '15727', '18173', 0),
('module', 'httpauth', 'lang-fi', '15727', '18173', 0),
('module', 'httpauth', 'lang-fr', '15727', '18173', 0),
('module', 'httpauth', 'lang-hu', '15727', '20954', 0),
('module', 'httpauth', 'lang-it', '15727', '18173', 0),
('module', 'httpauth', 'lang-ja', '15727', '18173', 0),
('module', 'httpauth', 'lang-ko', '15727', '18173', 0),
('module', 'httpauth', 'lang-lt', '15727', '18173', 0),
('module', 'httpauth', 'lang-no', '15727', '18173', 0),
('module', 'httpauth', 'lang-pl', '15727', '18173', 0),
('module', 'httpauth', 'lang-ro', '15727', '18173', 0),
('module', 'httpauth', 'lang-ru', '15727', '20954', 0),
('module', 'httpauth', 'lang-sk', '15727', '20954', 0),
('module', 'httpauth', 'lang-sr', '15727', '18173', 0),
('module', 'httpauth', 'lang-sv', '15727', '18173', 0),
('module', 'httpauth', 'lang-tr', '15727', '18173', 0),
('module', 'httpauth', 'lang-uk', '15727', '18173', 0),
('module', 'httpauth', 'lang-vi', '15727', '18173', 0),
('module', 'httpauth', 'lang-zh_CN', '15727', '18173', 0),
('module', 'httpauth', 'lang-zh_TW', '15727', '20954', 0),
('module', 'rearrange', 'base', '1.0.9', '20955', 0),
('module', 'rearrange', 'lang-af', '15342', '18174', 0),
('module', 'rearrange', 'lang-ar', '15342', '20954', 0),
('module', 'rearrange', 'lang-bg', '15342', '20954', 0),
('module', 'rearrange', 'lang-ca', '15342', '18174', 0),
('module', 'rearrange', 'lang-cs', '15342', '20954', 0),
('module', 'rearrange', 'lang-da', '15342', '18174', 0),
('module', 'rearrange', 'lang-de', '15342', '18174', 0),
('module', 'rearrange', 'lang-el', '15342', '20954', 0),
('module', 'rearrange', 'lang-en_GB', '15342', '18174', 0),
('module', 'rearrange', 'lang-es', '15342', '18174', 0),
('module', 'rearrange', 'lang-eu', '15342', '18174', 0),
('module', 'rearrange', 'lang-fa', '15342', '18174', 0),
('module', 'rearrange', 'lang-fi', '15342', '18174', 0),
('module', 'rearrange', 'lang-fr', '15342', '20954', 0),
('module', 'rearrange', 'lang-hu', '15342', '18174', 0),
('module', 'rearrange', 'lang-is', '15342', '20954', 0),
('module', 'rearrange', 'lang-it', '15342', '18174', 0),
('module', 'rearrange', 'lang-ja', '15342', '18174', 0),
('module', 'rearrange', 'lang-ko', '15342', '18174', 0),
('module', 'rearrange', 'lang-lt', '15342', '18174', 0),
('module', 'rearrange', 'lang-nl', '15342', '20954', 0),
('module', 'rearrange', 'lang-no', '15342', '18174', 0),
('module', 'rearrange', 'lang-pl', '15342', '18174', 0),
('module', 'rearrange', 'lang-pt_BR', '15342', '20954', 0),
('module', 'rearrange', 'lang-ro', '15342', '18174', 0),
('module', 'rearrange', 'lang-ru', '15342', '18174', 0),
('module', 'rearrange', 'lang-sk', '15342', '20954', 0),
('module', 'rearrange', 'lang-sl', '15342', '18174', 0),
('module', 'rearrange', 'lang-sr', '15342', '18174', 0),
('module', 'rearrange', 'lang-sv', '15342', '18174', 0),
('module', 'rearrange', 'lang-tr', '15342', '18174', 0),
('module', 'rearrange', 'lang-uk', '15342', '18174', 0),
('module', 'rearrange', 'lang-vi', '15342', '18174', 0),
('module', 'rearrange', 'lang-zh_CN', '15342', '18174', 0),
('module', 'rearrange', 'lang-zh_TW', '15342', '18174', 0),
('module', 'gd', 'base', '1.1.6', '20961', 0),
('module', 'gd', 'lang-af', '15342', '17580', 0),
('module', 'gd', 'lang-ar', '15342', '20954', 0),
('module', 'gd', 'lang-ca', '15342', '17580', 0),
('module', 'gd', 'lang-cs', '15342', '17580', 0),
('module', 'gd', 'lang-da', '15342', '17580', 0),
('module', 'gd', 'lang-de', '15342', '17580', 0),
('module', 'gd', 'lang-el', '15342', '20954', 0),
('module', 'gd', 'lang-en_GB', '15342', '17580', 0),
('module', 'gd', 'lang-es', '15342', '17594', 0),
('module', 'gd', 'lang-et', '15342', '17580', 0),
('module', 'gd', 'lang-eu', '15342', '17580', 0),
('module', 'gd', 'lang-fa', '15342', '17580', 0),
('module', 'gd', 'lang-fi', '15342', '17580', 0),
('module', 'gd', 'lang-fr', '15342', '20954', 0),
('module', 'gd', 'lang-hu', '15342', '17580', 0),
('module', 'gd', 'lang-is', '15342', '20954', 0),
('module', 'gd', 'lang-it', '15342', '17580', 0),
('module', 'gd', 'lang-ja', '15342', '17580', 0),
('module', 'gd', 'lang-ko', '15342', '17580', 0),
('module', 'gd', 'lang-lt', '15342', '17580', 0),
('module', 'gd', 'lang-lv', '15342', '17580', 0),
('module', 'gd', 'lang-nl', '15342', '17828', 0),
('module', 'gd', 'lang-no', '15342', '17580', 0),
('module', 'gd', 'lang-pl', '15342', '17580', 0),
('module', 'gd', 'lang-pt_BR', '15342', '20954', 0),
('module', 'gd', 'lang-ro', '15342', '17580', 0),
('module', 'gd', 'lang-ru', '15342', '17580', 0),
('module', 'gd', 'lang-sk', '15342', '20954', 0),
('module', 'gd', 'lang-sl', '15342', '17688', 0),
('module', 'gd', 'lang-sr', '15342', '17580', 0),
('module', 'gd', 'lang-sv', '15342', '17580', 0),
('module', 'gd', 'lang-tr', '15342', '17580', 0),
('module', 'gd', 'lang-uk', '15342', '17580', 0),
('module', 'gd', 'lang-vi', '15342', '17580', 0),
('module', 'gd', 'lang-zh_CN', '15342', '20954', 0),
('module', 'gd', 'lang-zh_TW', '15342', '20954', 0),
('module', 'multilang', 'base', '1.0.12', '20955', 0),
('module', 'multilang', 'lang-af', '16284', '18174', 0),
('module', 'multilang', 'lang-ar', '16284', '20954', 0),
('module', 'multilang', 'lang-ca', '16284', '18174', 0),
('module', 'multilang', 'lang-cs', '16284', '20954', 0),
('module', 'multilang', 'lang-da', '16284', '18174', 0),
('module', 'multilang', 'lang-de', '16284', '20954', 0),
('module', 'multilang', 'lang-el', '16284', '20954', 0),
('module', 'multilang', 'lang-en_GB', '16284', '18174', 0),
('module', 'multilang', 'lang-es', '16284', '18174', 0),
('module', 'multilang', 'lang-eu', '16284', '18174', 0),
('module', 'multilang', 'lang-fi', '16284', '18174', 0),
('module', 'multilang', 'lang-fr', '16284', '20954', 0),
('module', 'multilang', 'lang-hu', '16284', '18174', 0),
('module', 'multilang', 'lang-is', '16284', '20954', 0),
('module', 'multilang', 'lang-it', '16284', '18174', 0),
('module', 'multilang', 'lang-ja', '16284', '18174', 0),
('module', 'multilang', 'lang-ko', '16284', '18174', 0),
('module', 'multilang', 'lang-lt', '16284', '18174', 0),
('module', 'multilang', 'lang-nl', '16284', '20954', 0),
('module', 'multilang', 'lang-no', '16284', '18174', 0),
('module', 'multilang', 'lang-pl', '16284', '18174', 0),
('module', 'multilang', 'lang-ro', '16284', '18174', 0),
('module', 'multilang', 'lang-ru', '16284', '20954', 0),
('module', 'multilang', 'lang-sk', '16284', '18174', 0),
('module', 'multilang', 'lang-sr', '16284', '18174', 0),
('module', 'multilang', 'lang-sv', '16284', '18174', 0),
('module', 'multilang', 'lang-tr', '16284', '18174', 0),
('module', 'multilang', 'lang-uk', '16284', '18174', 0),
('module', 'multilang', 'lang-vi', '16284', '18174', 0),
('module', 'multilang', 'lang-zh_CN', '16284', '18174', 0),
('module', 'multilang', 'lang-zh_TW', '16284', '20954', 0),
('module', 'jpegtran', 'base', '1.0.1', '20955', 0),
('module', 'jpegtran', 'lang-af', '17028', '20954', 0),
('module', 'jpegtran', 'lang-ar', '17028', '20954', 0),
('module', 'jpegtran', 'lang-bg', '17028', '20954', 0),
('module', 'jpegtran', 'lang-ca', '17028', '18174', 0),
('module', 'jpegtran', 'lang-cs', '17028', '20954', 0),
('module', 'jpegtran', 'lang-da', '17028', '18174', 0),
('module', 'jpegtran', 'lang-de', '17028', '18174', 0),
('module', 'jpegtran', 'lang-el', '17028', '20954', 0),
('module', 'jpegtran', 'lang-en_GB', '17028', '18174', 0),
('module', 'jpegtran', 'lang-es', '17028', '18174', 0),
('module', 'jpegtran', 'lang-es_AR', '17028', '20954', 0),
('module', 'jpegtran', 'lang-es_MX', '17028', '20954', 0),
('module', 'jpegtran', 'lang-et', '17028', '18174', 0),
('module', 'jpegtran', 'lang-eu', '17028', '20954', 0),
('module', 'jpegtran', 'lang-fi', '17028', '20954', 0),
('module', 'jpegtran', 'lang-fr', '17028', '20954', 0),
('module', 'jpegtran', 'lang-ga', '17028', '20954', 0),
('module', 'jpegtran', 'lang-he', '17028', '18174', 0),
('module', 'jpegtran', 'lang-hu', '17028', '18174', 0),
('module', 'jpegtran', 'lang-it', '17028', '18174', 0),
('module', 'jpegtran', 'lang-ja', '17028', '20954', 0),
('module', 'jpegtran', 'lang-ko', '17028', '20954', 0),
('module', 'jpegtran', 'lang-lt', '17028', '18174', 0),
('module', 'jpegtran', 'lang-lv', '17028', '20954', 0),
('module', 'jpegtran', 'lang-nl', '17028', '20954', 0),
('module', 'jpegtran', 'lang-no', '17028', '20954', 0),
('module', 'jpegtran', 'lang-pl', '17028', '18174', 0),
('module', 'jpegtran', 'lang-pt', '17028', '18174', 0),
('module', 'jpegtran', 'lang-pt_BR', '17028', '20954', 0),
('module', 'jpegtran', 'lang-ro', '17028', '20954', 0),
('module', 'jpegtran', 'lang-ru', '17028', '18174', 0),
('module', 'jpegtran', 'lang-sk', '17028', '20954', 0),
('module', 'jpegtran', 'lang-sl', '17028', '18174', 0),
('module', 'jpegtran', 'lang-sr', '17028', '18174', 0),
('module', 'jpegtran', 'lang-sv', '17028', '18174', 0),
('module', 'jpegtran', 'lang-tr', '17028', '18174', 0),
('module', 'jpegtran', 'lang-uk', '17028', '18174', 0),
('module', 'jpegtran', 'lang-vi', '17028', '20954', 0),
('module', 'jpegtran', 'lang-zh_CN', '17028', '20954', 0),
('module', 'jpegtran', 'lang-zh_TW', '17028', '20954', 0),
('module', 'dcraw', 'base', '1.0.13', '20955', 0),
('module', 'dcraw', 'lang-af', '17028', '18173', 0),
('module', 'dcraw', 'lang-ar', '17028', '20954', 0),
('module', 'dcraw', 'lang-ca', '17028', '18173', 0),
('module', 'dcraw', 'lang-cs', '17028', '18173', 0),
('module', 'dcraw', 'lang-da', '17028', '18173', 0),
('module', 'dcraw', 'lang-de', '17028', '18173', 0),
('module', 'dcraw', 'lang-el', '17028', '20954', 0),
('module', 'dcraw', 'lang-en_GB', '17028', '18173', 0),
('module', 'dcraw', 'lang-es', '17028', '18173', 0),
('module', 'dcraw', 'lang-eu', '17028', '18173', 0),
('module', 'dcraw', 'lang-fi', '17028', '18173', 0),
('module', 'dcraw', 'lang-fr', '17028', '18173', 0),
('module', 'dcraw', 'lang-hu', '17028', '18173', 0),
('module', 'dcraw', 'lang-it', '17028', '18173', 0),
('module', 'dcraw', 'lang-ja', '17028', '18173', 0),
('module', 'dcraw', 'lang-ko', '17028', '18173', 0),
('module', 'dcraw', 'lang-lt', '17028', '18173', 0),
('module', 'dcraw', 'lang-nl', '17028', '18173', 0),
('module', 'dcraw', 'lang-no', '17028', '18173', 0),
('module', 'dcraw', 'lang-pl', '17028', '18173', 0),
('module', 'dcraw', 'lang-ro', '17028', '18173', 0),
('module', 'dcraw', 'lang-ru', '17028', '18173', 0),
('module', 'dcraw', 'lang-sk', '17028', '20954', 0),
('module', 'dcraw', 'lang-sr', '17028', '18173', 0),
('module', 'dcraw', 'lang-sv', '17028', '18173', 0),
('module', 'dcraw', 'lang-tr', '17028', '18173', 0),
('module', 'dcraw', 'lang-uk', '17028', '18173', 0),
('module', 'dcraw', 'lang-vi', '17028', '18173', 0),
('module', 'dcraw', 'lang-zh_CN', '17028', '18173', 0),
('module', 'dcraw', 'lang-zh_TW', '17028', '20954', 0);

-- --------------------------------------------------------

--
-- 表的结构 `dzg_PluginParameterMap`
--

CREATE TABLE IF NOT EXISTS `dzg_PluginParameterMap` (
  `dz_pluginType` varchar(32) NOT NULL,
  `dz_pluginId` varchar(32) NOT NULL,
  `dz_itemId` int(11) NOT NULL,
...
--
-- 转存表中的数据 `dzg_PluginParameterMap`
--

INSERT INTO `dzg_PluginParameterMap` (`dz_pluginType`, `dz_pluginId`, `dz_itemId`, `dz_parameterName`, `dz_parameterValue`) VALUES
...
('module', 'core', 0, 'default.language', 'zh_CN'),
...
--
-- 表的结构 `dzg_RecoverPasswordMap`
--

CREATE TABLE IF NOT EXISTS `dzg_RecoverPasswordMap` (
  `dz_userName` varchar(32) NOT NULL,
...
--
-- 转存表中的数据 `dzg_RecoverPasswordMap`
--
...
CREATE TABLE IF NOT EXISTS `dzg_Schema` (
...
INSERT INTO `dzg_Schema` (`dz_name`, `dz_major`, `dz_minor`, `dz_createSql`, `dz_pluginId`, `dz_type`, `dz_info`) VALUES
...
--
-- 表的结构 `dzg_SequenceEventLog`
--

CREATE TABLE IF NOT EXISTS `dzg_SequenceEventLog` (
  `id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- 转存表中的数据 `dzg_SequenceEventLog`
--

INSERT INTO `dzg_SequenceEventLog` (`id`) VALUES
(0);
...
CREATE TABLE IF NOT EXISTS `dzg_SequenceId` (
  `id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- 转存表中的数据 `dzg_SequenceId`
--

INSERT INTO `dzg_SequenceId` (`id`) VALUES
(31);

-- --------------------------------------------------------

--
-- 表的结构 `dzg_SequenceLock`
--

CREATE TABLE IF NOT EXISTS `dzg_SequenceLock` (
  `id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- 转存表中的数据 `dzg_SequenceLock`
--

INSERT INTO `dzg_SequenceLock` (`id`) VALUES
(0);
...
CREATE TABLE IF NOT EXISTS `dzg_SessionMap` (
...
--
-- 表的结构 `dzg_TkOperatnMimeTypeMap`
--

CREATE TABLE IF NOT EXISTS `dzg_TkOperatnMimeTypeMap` (
...
--
-- 转存表中的数据 `dzg_TkOperatnMimeTypeMap`
--
...
--
-- 表的结构 `dzg_TkOperatnParameterMap`
--

CREATE TABLE IF NOT EXISTS `dzg_TkOperatnParameterMap` (
  `dz_operationName` varchar(128) NOT NULL,
...
--
-- 转存表中的数据 `dzg_TkOperatnParameterMap`
--
...
--
-- 表的结构 `dzg_TkPropertyMap`
--

CREATE TABLE IF NOT EXISTS `dzg_TkPropertyMap` (
  `dz_name` varchar(128) NOT NULL,
  `dz_type` varchar(128) NOT NULL,
...
--
-- 表的结构 `dzg_TkPropertyMimeTypeMap`
--

CREATE TABLE IF NOT EXISTS `dzg_TkPropertyMimeTypeMap` (
...
--
-- 转存表中的数据 `dzg_TkPropertyMimeTypeMap`
--
...
--
-- 表的结构 `dzg_UnknownItem`
--

CREATE TABLE IF NOT EXISTS `dzg_UnknownItem` (
  `dz_id` int(11) NOT NULL,
  PRIMARY KEY (`dz_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- 转存表中的数据 `dzg_UnknownItem`
--
...
CREATE TABLE IF NOT EXISTS `dzg_User` (
  `dz_id` int(11) NOT NULL,
  `dz_userName` varchar(32) NOT NULL,
...
INSERT INTO `dzg_User` (`dz_id`, `dz_userName`, `dz_fullName`, `dz_hashedPassword`, `dz_email`, `dz_language`, `dz_locked`) VALUES
(5, 'guest', 'Guest', 'AIRNca93df8019009594b8ec361fe5049c73', NULL, NULL, 0),
(6, 'admin', 'Dazzle', 'Ksgqd18685612805fa33f57d2dfd9a27c145', 'dazzle@dazzle.com', NULL, 0);

-- --------------------------------------------------------

--
-- 表的结构 `dzg_UserGroupMap`
--

CREATE TABLE IF NOT EXISTS `dzg_UserGroupMap` (
  `dz_userId` int(11) NOT NULL,
...
--
-- 转存表中的数据 `dzg_UserGroupMap`
--

INSERT INTO `dzg_UserGroupMap` (`dz_userId`, `dz_groupId`) VALUES
(6, 2),
(5, 4),
(6, 4),
(6, 3);
