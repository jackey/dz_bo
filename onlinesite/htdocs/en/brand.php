        ...
        <div class="vessel">
            ...
            <?php foreach ($brandNames as $key => $brandName): ?>
                ...
                <div class="<?php echo $key?> pic hexagon">
                    ...
                    <a href="javascript:void(0)" data-href="/en/brandpage.php?brand=<?php echo strtolower($key)?>" data-src="<?php echo $brand->brand_navigation_full_image?>" class="brandpage">
                        <?php if ($key == "Dazzle"): ?>
...
<!-- 			<div class="Diamond pic hexagon">
                ...
                <a href="javascript:void(0)" data-href="/en/brandpage.php?brand=diamond" data-src="/images/bgdiamond.jpg" class="brandpage"><img src="/images/linkdiamond.png"/></a>
            </div>
			<div class="dzzit pic hexagon">
            	<img src="/images/branddzzit.png" />
                <a href="javascript:void(0)" data-href="/en/brandpage.php?brand=dzzit" data-src="/images/bgdzzit.jpg" class="brandpage"><img src="/images/linkdzzit.png" /></a>
            </div>
			<div class="Dazzle pic hexagon">
            	<img src="/images/brandDazzle.png" />
                <a href="javascript:void(0)" data-href="/en/brandpage.php?brand=dazzle" data-src="/images/bgdazzle.jpg" class="brandpage"><img src="/images/linkDazzle.png" /></a>
            </div> -->
            <div class="menu">
            	<ul>
                    ...
                    <li class="menulogo"><a href="/en/index.php"><img src="/images/menulogo.png" /></a></li>
