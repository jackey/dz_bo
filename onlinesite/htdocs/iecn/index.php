...
<body id="information">
    ...
    <div class="wrap">
    	<div class="vessel index">
        	<div class="logo">
            	<div class="vesselbox">
                    <a href="javascript:void(0)"  data-href="/iecn/brand.php" id="logotxt"><img src="/images/logo2.png" /></a>
			...
			<div class="menu">
                ...
                <div class="cont">
                	<ul>
                    	...
                    	<li><a  href="javascript:void(0)" data-source="dazzless" class="videoitem" >DAZZLE 2014 春夏拍摄花絮</a></li>
                    	<li><a  href="javascript:void(0)" data-source="dzzitss" class="videoitem" >d'zzit 2014春夏拍摄花絮</a></li>
                    </ul>                
                </div>
            </div>
            <div class="videobox">
