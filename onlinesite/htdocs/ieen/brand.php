            ...
            <?php foreach ($brandNames as $key => $brandName): ?>
                ...
                <div class="<?php echo $key?> pic hexagon">
                   <img src="<?php echo getThumbnailURL($brand->brand_navigation_image)?>"> 
                    <a href="javascript:void(0)" data-href="/ieen/brandpage.php?brand=<?php echo strtolower($key)?>" data-src="<?php echo getThumbnailURL($brand->brand_navigation_full_image)?>" class="brandpage">
                        <?php if ($key == "Diamond"): ?>
