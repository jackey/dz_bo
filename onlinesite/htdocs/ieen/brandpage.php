                    ...
                    <div class="item <?php echo $key?>">
                      <div class="pic"><img src="<?php echo getThumbnailURL($brand_obj->brand_master_image) ?>" /></div>
                        ...
                        <?php if ($key == "Dazzle"): ?>
                          ...
                          <map name="Map">
                            <area shape="rect" coords="411,60,480,196" href="/ieen/lookbook.php?brand=<?php echo strtolower($key)?>">
                            <area shape="rect" coords="484,217,600,247" href="/ieen/lookbook.php?brand=<?php echo strtolower($key)?>">
                            <area shape="rect" coords="332,198,407,326" href="/ieen/arrivals.php?brand=<?php echo strtolower($key)?>">
                            <area shape="rect" coords="400,349,506,381" href="/ieen/arrivals.php?brand=<?php echo strtolower($key)?>">
                          </map>
                          <map name="Mapsmall">
                              <area shape="rect" coords="308,46,367,148" href="/ieen/lookbook.php?brand=<?php echo strtolower($key)?>" />
                              <area shape="rect" coords="372,159,426,181" href="/ieen/lookbook.php?brand=<?php echo strtolower($key)?>" />
                              <area shape="rect" coords="255,151,311,238" href="/ieen/arrivals.php?brand=<?php echo strtolower($key)?>" />
                              <area shape="rect" coords="308,254,397,271" href="/ieen/arrivals.php?brand=<?php echo strtolower($key)?>" />
                          </map>
                        </div>
                      ...
                      <?php else: ?>
                        ...
                        <a href="/ieen/lookbook.php?brand=<?php echo strtolower($key)?>" class="brandpagearrow"><img src="/images/dazzlearrow.png" /></a>
                    </div>
                <?php endforeach;?>
                  </div>
              </div>
