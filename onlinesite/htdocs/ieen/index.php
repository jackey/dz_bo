...
<body id="information">
    ...
    <div class="fixver">
        <ul>
            ...
            <li class="menuitem"><a href="/iecn/index.php">中文</a></li>
        </ul>
    </div>
    <div class="wrap">
    	<div class="vessel index">
        	<div class="logo">
                <div class="vesselbox">
                    ...
                    <a href="javascript:void(0)"  data-href="/ieen/brand.php" id="logotxt"><img src="/images/logo2.png" /></a>
...
<!--         <div class="vessel info1">
		...
		<div class="vessel info2">
			...
			<div class="pic">
            	<div class="relative">
                    ...
                    <?php endif;?>
                    <map name="Map">
                      <area shape="poly" coords="111,157,19,317,111,476,292,476,385,315,293,159" href="/ieen/brandpage.php?brand=diamond">
                      <area shape="poly" coords="293,158,383,1,569,3,657,157,569,317,386,314" href="/ieen/brandpage.php?brand=dazzle">
                      <area shape="poly" coords="386,316,292,475,383,634,566,633,657,471,568,318" href="/ieen/brandpage.php?brand=dzzit">
                    </map>
                    <map name="Mapsmall">
                      <area shape="poly" coords="95,124,17,253,92,380,242,381,321,255,243,126" href="/ieen/brandpage.php?brand=diamond">
                      <area shape="poly" coords="242,128,324,-6,476,1,547,127,472,255,322,256" href="/ieen/brandpage.php?brand=dazzle">
                      <area shape="poly" coords="322,255,245,381,320,509,473,508,549,381,473,254" href="/ieen/brandpage.php?brand=dzzit">
                    </map>
                </div>
            </div>
			<div class="text">
        ...
        <div class="vessel infomedia">
            ...
            <div class="videobox">
                <video id="beginVideo" data-poster="<?php echo getThumbnailURL($video->thumbnail)?>"
                     controls
                     loop="loop"> 
