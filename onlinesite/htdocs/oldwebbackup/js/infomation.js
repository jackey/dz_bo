	...
	$("#information .index #logotxt").fadeIn(500,function(){
	 ...
	 $(".videoitem").click(function(){
		 var datasource=$(this).attr("data-source");
			$(".infomedia .videobox").html("<video id=\"beginVideo\"  controls loop=\"loop\">  <source src=\"/video/"+datasource+".mp4\" type='video/mp4; codecs=\"avc1.42E01E, mp4a.40.2\"' /> <source src=\"/video/"+datasource+".webm\" type='video/webm; codecs=\"vp8, vorbis\"' /> <div id=\"mediaplayer\">JW Player goes here</div>  </video>");	
			jwplayer("mediaplayer").setup({
				flashplayer: "/flash/player.swf",
				file: "/video/"+datasource+".mp4"
			});
	});
