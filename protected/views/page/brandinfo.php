<div class="tabbable">
  <div class="nav nav-tabs">
    ...
    <li class="active"><a href="<?php echo Yii::app()->createUrl("page/brandinfo", array("brand" => Yii::app()->getRequest()->getParam("brand")))?>"><?php echo Yii::t("strings", "Brand Story")?></a></li>  
  </div>
  <div class="tab-content">
    <div class="form-con brand-info-form" ng-controller="BrandinfoController" ng-init="init()">
      <form name="brandform">
